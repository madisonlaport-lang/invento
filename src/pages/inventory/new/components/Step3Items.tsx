              ...
              <div className="flex flex-col gap-3">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-7 pr-3 py-2 text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-500/30 focus:border-amber-500 bg-white"
                  />
                </div>
